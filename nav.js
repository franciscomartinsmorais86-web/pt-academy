/* Nav fixo: o fundo preto, o padding e a troca do hamburger pela lista
   são todos interpolados ao longo do scroll, não disparados num ponto.

   A transição corre entre estas duas frações da altura do ecrã, ou seja
   termina mesmo à saída do hero. */
var NAV_START = 0.55;
var NAV_END = 1.05;
